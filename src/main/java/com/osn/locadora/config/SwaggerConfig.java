...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.osn.locadora.resources")).paths(PathSelectors.any())
				.build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API gerenciador Hospedagem Casinhas Brisas do Farol",
				"Esta API é utilizada no controle de reservas da Casinhas Brisas do Farol", "Versão 1.0", null,
				new Contact("Osvaldo da Silva Neto", "https://github.com/osvaldosneto", "osneto@hotmail.com"),
				"não permitido o uso ou cópia sem prévia autorização!!", null, Collections.emptyList() // Vendor
																										// Extensions
		);
	}
	...
	private ResponseMessage customMessage1() {	
		...
		return new ResponseMessageBuilder()
				.code(201).message("Recurso criado")
